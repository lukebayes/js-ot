...
dist/$(PROJECT_NAME).js: index.js src/*
	$(WEBPACK) --config $(WEBPACK_CLIENT_CONFIG) index.js dist/$(PROJECT_NAME).js

dist/$(PROJECT_NAME).min.js: index.js src/*
	$(WEBPACK) --optimize-minimize --config $(WEBPACK_CLIENT_CONFIG) index.js dist/$(PROJECT_NAME).min.js

dist/$(PROJECT_NAME).min.gz:
